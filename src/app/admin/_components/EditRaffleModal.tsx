  ...
  useEffect(() => {
    if (raffle) {
      reset({
        ...
        awardedNumbers: raffle.awardedQuotes?.map(quote => ({
          id: quote.id,
  ...
  return (
    <div className={`fixed inset-0 bg-black/50 p-4 flex items-center backdrop-blur-xs justify-center z-50 ${isOpen ? 'block' : 'hidden'}`}>
      <div className="bg-white text-foreground rounded-xl w-full max-w-2xl py-4 md:py-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 pb-2 overflow-y-auto max-h-[80vh] px-4 md:px-6 mb-2">
          <div>
